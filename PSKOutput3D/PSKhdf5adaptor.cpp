...
void HDF5OutputAdaptor::write(const std::string & objname, const Dimens dimens, doubleCar3 d_array) {
  if (dimens.size() != 3) {
    eprintf("Dimens size not 3 for object %s", objname.c_str());
    //PSK::OutputException e("Dimens size not 3 for object " + objname, "HDF5OutputAdaptor::write(doubleCar3 array)");
    //throw e;
  }
  ...
  //}
  //catch(PSK::Exception & e) {
  //  e.push("In HDF5OutputAdaptor::write(doubleCar3 array)");
  //  throw e;
  //}
}

void HDF5OutputAdaptor::write(const std::string & objname, const Dimens dimens, const int ns, doubleCar4 d_array) {
  if (dimens.size() != 3) {
    eprintf("Dimens size not 3 for object %s", objname.c_str());
    //PSK::OutputException e("Dimens size not 3 for object " + objname, "HDF5OutputAdaptor::write(doubleCar4 array)");
    //throw e;
  }
  ...
  //}
  //catch(PSK::Exception & e) {
  //  e.push("In HDF5OutputAdaptor::write(doubleCar4 array)");
  //  throw e;
  //}
}
...
void HDF5OutputAdaptor::write(const std::string & objname, const Dimens dimens, const int ns, doubleCar3 d_array) {
  if (dimens.size() != 2) {
    eprintf("Dimens size not 2 for object %s", objname.c_str());
    //PSK::OutputException e("Dimens size not 2 for object " + objname, "HDF5OutputAdaptor::write(doubleCar3 array)");
    //throw e;
  }
