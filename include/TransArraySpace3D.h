...
inline void solver2phys(doubleArr3& vectPhys, double *vectSolver, int nx, int ny, int nz) {
...
/** method to convert a 1D field in a 3D field not considering guard cells*/
inline void solver2phys(doubleArr3& vectPhys1, doubleArr3& vectPhys2, doubleArr3& vectPhys3, double *vectSolver, int nx, int ny, int nz) {
  for (register int i = 1; i < nx - 1; i++)
    for (register int j = 1; j < ny - 1; j++)
      for (register int k = 1; k < nz - 1; k++) {
...
inline void phys2solver(double *vectSolver, const doubleArr3& vectPhys, int nx, int ny, int nz) {
  for (register int i = 1; i < nx - 1; i++)
    for (register int j = 1; j < ny - 1; j++)
      for (register int k = 1; k < nz - 1; k++)
...
/** method to convert a 3D field in a 1D field not considering guard cells*/
inline void phys2solver(double *vectSolver, const doubleArr3& vectPhys1, const doubleArr3& vectPhys2, const doubleArr3& vectPhys3, int nx, int ny, int nz) {
  for (register int i = 1; i < nx - 1; i++)
    for (register int j = 1; j < ny - 1; j++)
      for (register int k = 1; k < nz - 1; k++) {
