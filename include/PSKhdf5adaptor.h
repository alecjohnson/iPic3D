...
namespace PSK {
  ...
  public:
    ...
    void write(const std::string & objname, const Dimens dimens, doubleCar3 d_array);
    void write(const std::string & objname, const Dimens dimens, const int i, doubleCar4 d_array);

    void write(const std::string & objname, const Dimens dimens, double **d_array);

    void write(const std::string & objname, const Dimens dimens, const int i, doubleCar3 d_array);
