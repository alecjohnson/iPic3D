...
class PHDF5fileClass{
  ...
  public:
    ...
    void ClosePHDF5file();
    void OpenPHDF5file();
    void ReadPHDF5dataset_double(string dataset, doubleArr3& data);
    void ReadPHDF5param();
    int  WritePHDF5dataset(string grpname, string datasetname, doubleCar3& data, int nx, int ny, int nz);
