...
int PHDF5fileClass::WritePHDF5dataset(string grpname, string datasetname, doubleCar3& data, int nx, int ny, int nz){
...
void PHDF5fileClass::ReadPHDF5dataset_double(string datasetname, doubleArr3& data){
